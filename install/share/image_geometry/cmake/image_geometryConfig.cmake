...
if("FALSE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/johann/catkin_ws_matchbox/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/johann/catkin_ws_matchbox/devel/.private/image_geometry)
  ...
  set(image_geometry_INSTALL_PREFIX /home/johann/catkin_ws_matchbox/install)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/johann/catkin_ws_matchbox/install/${idir}'.  ${_report}")
    endif()
