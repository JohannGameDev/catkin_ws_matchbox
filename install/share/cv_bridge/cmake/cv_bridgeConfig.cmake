...
if("FALSE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/johann/catkin_ws_matchbox/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/johann/catkin_ws_matchbox/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/johann/catkin_ws_matchbox/install)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/johann/catkin_ws_matchbox/install/${idir}'.  ${_report}")
    endif()
