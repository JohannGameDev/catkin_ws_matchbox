...
class Map:
    ...
    def __init__(self):
        self.lane_1 = np.load("/home/johann/catkin_ws_matchbox/src/assignment9_navigation/data/lane1.npy")
        self.lane_2 = np.load("/home/johann/catkin_ws_matchbox/src/assignment9_navigation/data/lane2.npy")
        self.lanes = [
